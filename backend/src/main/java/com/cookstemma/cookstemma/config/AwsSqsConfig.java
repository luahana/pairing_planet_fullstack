...
/**
 * AWS SQS Configuration for translation event queue.
 * Enables real-time push-based translation processing.
 *
 * Hybrid Architecture:
 * - Push: Backend sends SQS message → Lambda triggered immediately
