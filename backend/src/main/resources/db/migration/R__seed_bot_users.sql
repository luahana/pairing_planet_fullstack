...
-- chef_park_soojin
INSERT INTO users (username, role, status, locale, default_cooking_style, is_bot, persona_id, created_at, updated_at)
...
INSERT INTO bot_api_keys (key_prefix, key_hash, bot_user_id, name, is_active, created_at, updated_at)
SELECT 'pp_bot_1',
