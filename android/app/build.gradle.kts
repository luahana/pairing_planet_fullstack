...
android {
    namespace = "com.cookstemma.app"
    compileSdk = 34

    defaultConfig {
        applicationId = "com.cookstemma.app"
        minSdk = 26
        targetSdk = 34
        versionCode = 1
        versionName = "1.0.0"
    ...
    productFlavors {
        create("dev") {
            ...
            buildConfigField("String", "API_BASE_URL", "\"https://dev.cookstemma.com/api/v1/\"")
            resValue("string", "app_name", "Cookstemma Dev")
        }
        create("prod") {
            dimension = "environment"
